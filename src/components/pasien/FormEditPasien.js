...
const FormEditPasien = ({ open, setOpen, pasien, refreshData, ...rest }) => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Edit Pasien | Sistem Informasi Rekapitulasi Penderita Kanker Kota
          Cimahi
        </title>
      </Helmet>
      {open ? (
          ...
          <Box>
            ...
            <Formik
              initialValues={{
                ...
                diagnose: pasien.diagnose,
                additional_diagnose: pasien.additional_diagnose,
                status_diagnose: pasien.status_diagnose,
                payment_method: pasien.payment_method,
                inputDiagnose: ''
              }}
              ...
              onSubmit={async ({
                ...
                inputDiagnose
                  ...
                  const data = {
                    ...
                    gender: gender,
                    diagnose:
                      diagnose !== 'none of the above' ? diagnose : inputDiagnose,
                    additional_diagnose: additional_diagnose,
                    status_diagnose: status_diagnose,
                    payment_method: payment_method,
                    month_checkup: bulan[thisMonth - 1],
                    year_checkup: thisYear
                  };
                  
                  handleIsLoading();

                  const response = await axios.put(`http://localhost:1337/pasien/${pasien._id}`, data)
                    ...
                    <Grid item>
                      ...
                      >
                        {touched.payment_method && errors.payment_method
                          ...
                          : '*Umum untuk pembayaran diluar BPJS'}
                      </FormHelperText>
                    </Grid>
                  </Grid>
                  <Grid
